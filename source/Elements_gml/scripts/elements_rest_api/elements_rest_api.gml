...
#export elements_adjust_advanced_inventory_item_quantity, elements_adjust_simple_inventory_item_quantity, elements_blacklist_session, elements_build_indexes, elements_callback, elements_complete_reset, elements_complete_verification, elements_confirm_oidc_session_link, elements_consume_oculus_iap_purchase, elements_create_advanced_inventory_item, elements_create_application, elements_create_custom_auth_scheme, elements_create_distinct_inventory_item, elements_create_element_deployment, elements_create_facebook_application_configuration, elements_create_facebook_iap_receipt, elements_create_fcm_registration, elements_create_firebase_application_configuration, elements_create_follower, elements_create_google_play_application_configuration, elements_create_ios_application_configuration, elements_create_item, elements_create_large_object, elements_create_large_object_from_url, elements_create_leaderboard, elements_create_match, elements_create_matchmaking_application_configuration, elements_create_metadata, elements_create_metadata_spec, elements_create_mission, elements_create_mock_session, elements_create_multipart_large_object, elements_create_new_deployment, elements_create_oauth2_auth_scheme, elements_create_oauth2_session, elements_create_oculus_application_configuration, elements_create_oculus_iap_receipt, elements_create_oidc_auth_scheme, elements_create_oidc_session, elements_create_oidc_session_1, elements_create_product_bundle, elements_create_product_sku_schema, elements_create_profile, elements_create_progress, elements_create_provider_configuration, elements_create_psn_application_configuration, elements_create_receipt, elements_create_save_document, elements_create_schedule, elements_create_schedule_event, elements_create_score, elements_create_simple_inventory_item, elements_create_smart_contract, elements_create_steam_application_configuration, elements_create_user, elements_create_username_password_session, elements_create_vault, elements_create_wallet, elements_deactivate_profile, elements_deactivate_user, elements_delete_advanced_inventory_item, elements_delete_all_matches, elements_delete_application, elements_delete_contract, elements_delete_custom_auth_scheme, elements_delete_deployment, elements_delete_distinct_inventory_item, elements_delete_element_deployment, elements_delete_facebook_application_configuration, elements_delete_fcm_registration, elements_delete_firebase_application_configuration, elements_delete_follower, elements_delete_friend_registration, elements_delete_google_play_application_configuration, elements_delete_ios_application_configuration, elements_delete_item, elements_delete_large_object, elements_delete_leaderboard, elements_delete_match, elements_delete_matchmaking_application_configuration, elements_delete_metadata, elements_delete_metadata_spec, elements_delete_mission, elements_delete_oauth2_auth_scheme, elements_delete_oculus_application_configuration, elements_delete_oidc_auth_scheme, elements_delete_product_bundle, elements_delete_product_sku_schema, elements_delete_progress, elements_delete_provider_configuration, elements_delete_psn_application_configuration, elements_delete_receipt, elements_delete_save_document, elements_delete_schedule, elements_delete_schedule_event, elements_delete_simple_inventory_item, elements_delete_steam_application_configuration, elements_delete_vault, elements_delete_wallet, elements_generate_code, elements_get_advanced_inventory_item, elements_get_advanced_inventory_items, elements_get_all_builtin_spis, elements_get_all_containers, elements_get_all_features, elements_get_all_runtimes, elements_get_all_system_elements, elements_get_application, elements_get_application_profiles, elements_get_applications, elements_get_current_deployment, elements_get_current_profile, elements_get_current_user, elements_get_custom_auth_scheme, elements_get_custom_auth_schemes, elements_get_deployment, elements_get_deployments, elements_get_distinct_inventory_item, elements_get_distinct_inventory_items, elements_get_editor_schema, elements_get_element_deployment, elements_get_element_deployments, elements_get_element_path_record_for_artifact, elements_get_element_path_record_for_large_object_id, elements_get_facebook_application_configuration, elements_get_facebook_iap_receipt, elements_get_facebook_iap_receipts, elements_get_firebase_application_configuration, elements_get_followees, elements_get_follower, elements_get_followers, elements_get_friend, elements_get_friends, elements_get_global_rank_tabular, elements_get_google_play_application_configuration, elements_get_ios_application_configuration, elements_get_item_by_identifier, elements_get_items, elements_get_json_schema, elements_get_large_object, elements_get_large_objects, elements_get_leaderboard, elements_get_leaderboards, elements_get_ledger_entries, elements_get_match, elements_get_matched_user_profiles_with_phone_numbers, elements_get_matches, elements_get_matchmaking_application_configuration, elements_get_metadata_object, elements_get_metadata_objects, elements_get_metadata_spec, elements_get_metadata_specs, elements_get_mission_by_name_or_id, elements_get_missions, elements_get_oauth2_auth_scheme, elements_get_oauth2_auth_schemes, elements_get_oculus_application_configuration, elements_get_oculus_iap_receipt, elements_get_oculus_iap_receipts, elements_get_oidc_auth_scheme, elements_get_oidc_auth_schemes, elements_get_plans, elements_get_product_bundle, elements_get_product_bundle_by_key, elements_get_product_bundles, elements_get_product_sku_schema, elements_get_product_sku_schemas, elements_get_profile, elements_get_profile_save_data_document_by_slot, elements_get_profiles, elements_get_progress_by_name_or_id, elements_get_progress_tabular, elements_get_provider_configuration, elements_get_provider_configurations, elements_get_psn_application_configuration, elements_get_rank_among_friends, elements_get_rank_among_mutual_followers, elements_get_receipt, elements_get_receipts, elements_get_reward_issuance, elements_get_reward_issuances, elements_get_reward_issuances_for_oculus_iap_receipt, elements_get_save_data_document, elements_get_save_data_documents, elements_get_schedule_by_name_or_id, elements_get_schedule_event_by_name_or_id, elements_get_schedule_events, elements_get_schedule_progresses, elements_get_schedules, elements_get_server_health, elements_get_simple_inventory_item, elements_get_simple_inventory_items, elements_get_smart_contract, elements_get_smart_contracts, elements_get_steam_application_configuration, elements_get_user, elements_get_user_save_data_document_by_slot, elements_get_users, elements_get_vault, elements_get_vaults, elements_get_version, elements_get_wallet, elements_get_wallet_for_vault, elements_get_wallets, elements_inspect_uploaded_elm, elements_link_email_password, elements_link_oauth2, elements_link_oidc, elements_link_username_password, elements_poll_oidc_session, elements_redeem_facebook_iap_purchase, elements_redeem_reward_issuance, elements_redeem_reward_issuances, elements_request_reset, elements_request_verification, elements_sign_up_user, elements_sign_up_user_and_create_session, elements_update_advanced_inventory_item, elements_update_application, elements_update_custom_auth_scheme, elements_update_deployment, elements_update_distinct_inventory_item, elements_update_element_deployment, elements_update_facebook_application_configuration, elements_update_firebase_application_configuration, elements_update_google_play_application_configuration, elements_update_ios_application_configuration, elements_update_item, elements_update_large_object, elements_update_large_object_contents, elements_update_leaderboard, elements_update_match, elements_update_matchmaking_application_configuration, elements_update_metadata, elements_update_metadata_spec, elements_update_mission, elements_update_oauth2_auth_scheme, elements_update_oculus_application_configuration, elements_update_oidc_auth_scheme, elements_update_product_bundle, elements_update_product_bundle_for_google_play_application_configuration, elements_update_product_bundle_for_ios_application_configuration, elements_update_profile, elements_update_profile_image, elements_update_progress, elements_update_provider_configuration, elements_update_psn_application_configuration, elements_update_registration, elements_update_save_document, elements_update_schedule, elements_update_schedule_event, elements_update_simple_inventory_item, elements_update_smart_contract, elements_update_steam_application_configuration, elements_update_user, elements_update_user_password, elements_update_vault, elements_update_wallet, elements_upload_apple_iap_receipt, elements_upload_google_play_iap_purchase, elements_upload_steam_iap_purchase, elements_verify_oculus_iap_purchase
