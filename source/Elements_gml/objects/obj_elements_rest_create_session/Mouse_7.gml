...
elements_session_create_username_password_session(_session_request, function(_code, _data, _request) {
	if (_code == 200) 
	{
	...
	show_debug_message($"elements_session_create_username_password_session :: {_data}");
});
